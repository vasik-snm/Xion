	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{ url('admin_assets/assets/images/logo-icon.png') }}" class="logo-icon" alt="logo icon">
				</div>
				<div>
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					{{-- <ul>
						<li> <a href="index.html"><i class='bx bx-radio-circle'>B</i></a>
						</li>
						<li> <a href="index2.html"><i class='bx bx-radio-circle'></i></a>
						</li>
						<li> <a href="index3.html"><i class='bx bx-radio-circle'></i></a>
						</li>
					</ul> --}}
				</li>
				{{-- <li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{ url('/home_banner') }}"><i class='bx bx-radio-circle'></i>Banner</a></li>
						<li> <a href="{{ url('/home_about_us') }}"><i class='bx bx-radio-circle'></i>About Us</a></li>
				...
				<nav class="navbar navbar-expand gap-3">
									...
									<div class="header-message-list">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/09.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img src="../images/profile_pic.png" class="user-img" alt="User details">
							<div class="user-info">
